...
if __name__ == "__main__":
    ...
    #createcorpus_again(data)
    
    #place data back into the file and overwrite corpus
    #or do preprocessing during the actual corpus make    
