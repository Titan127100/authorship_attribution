...
if __name__ == "__main__":
    ...
    output_file('test_results/spanish_result.txt',test_score, test_score1, test_score2, test_score3, test_score4, test_score5, test_score6, test_score7, test_score8, test_score9) # soz but can is it possible if you can write the output file because my brain is fried at this point